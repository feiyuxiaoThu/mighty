...
namespace dynus
{
    ...
    private:
        ...
        void objectTrackingCallback(const geometry_msgs::msg::PoseStamped &msg);
        ...
        void publishPoly();
        visualization_msgs::msg::MarkerArray makeLineStrip(const std::vector<state> &data, const std::string &ns, int id, double max_value, const rclcpp::Time &stamp);
        void clearNamespace(const std::string &ns, rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr pub);
        void publishTraj();
        void publishOwnTraj();
        ...
        pcl::PointCloud<pcl::PointXYZ> removeClosePoints(const pcl::PointCloud<pcl::PointXYZ>& cloud, float min_distance);

...
namespace lbfgs
{
    ...
    struct planner_params_t
    {
        ...
        double V_nom = 1.0;       // nominal velocity
        ...
        double seam_min_dist = 0.3;            // min distance between seams to keep
    };
    ...
    protected:
        ...
        // Dynamic constraints
        double V_nom_; // Nominal velocity
        double V_max_;
        double A_max_;
        double J_max_;
        ...
        double seam_min_dist_ = 0.3;            // min distance between seams to keep

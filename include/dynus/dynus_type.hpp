...
struct parameters
{
  ...
  bool use_static_push; // [-] Use static push
  ...
  double horizon;
  double dc;
  double v_nom; // [m/s] Nominal velocity
  double v_max;
  double a_max;
  double j_max;
  ...
  double second_to_last_vel_scale; // scale for the second to last velocity vector in the optimization
  ...
  double seam_min_dist; // min distance between two consecutive waypoints in the global path
  ...
  // Octomap
  bool remove_close_points;
  double remove_close_points_radius;

  // Object tracking parameters
  double ot_rel_x; // [m] Relative x position for object tracking
  double ot_rel_y; // [m] Relative y position for object tracking
  double ot_rel_z; // [m] Relative z position for object tracking
};

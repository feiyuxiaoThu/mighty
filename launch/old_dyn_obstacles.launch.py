...
def generate_random_obstacle_ld(urdf_path: str):
    ...
    map_range = [[35.0, 65.0], [-20.0, 20.0], [1.0, 6.0]] # Global planner Benchmarking
    scale_range = [[5.0, 10.0], [5.0, 10.0], [0.0, 0.0]] # [scale_x_min, scale_x_max], [scale_y_min, scale_y_max], [scale_z_min, scale_z_max]
    offset_range = [0.0, 3.0] # [offset_min, offset_max]
    slower_range = [10.0, 12.0] # [slower_min, slower_max]
